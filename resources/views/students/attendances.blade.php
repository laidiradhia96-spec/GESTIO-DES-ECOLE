        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-4">
                    Historique complet de vos présences
                </p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm bg-white dark:bg-gray-800 p-6">
                ...
                <div class="flex items-center justify-between gap-4 mb-5">
                    ...
                    <div>
                        ...
                        <h3 class="text-lg
                            ...
                            Filtrer vos présences
                        </h3>

                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Filtrez par année scolaire, date ou enseignant.
                        </p>
                ...
                <form method="GET"
                      action="{{ route('student.attendances') }}">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Consultez l'ensemble de vos présences
                            </p>
                        </div>
                ...
                @else
                    ...
                    <div class="p-10 text-center">
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            Modifiez ou réinitialisez vos filtres pour afficher vos présences.
                        </p>
                    </div>
